...
const debug = require('debug')('lemon-backbone-server');
...
//! load configuration.
const handler = require('lemoncloud-backbone-js')(global, env);
...
//! rewrite router mapping!.
//TODO - auto-decode serverless.yml
...
//     _inf(NS, "Express server has started on port 3000.", _)
// })
